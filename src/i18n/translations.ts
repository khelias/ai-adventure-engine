...
export const translations: Record<Language, StringTable> = {
  et: {
    ...
    prevStepBtn: '← Tagasi',
    step1Title: 'Vali žanr',
    step2Title: 'Kes mängivad?',
    step3Title: 'Seo mäng selle kohaga',
    step4Title: 'Anna loole säde',
    setupStepLabel: (step, total) => `${step} / ${total}`,
    setupContextNote: 'See väli on vabatahtlik. Kui midagi head ei tule pähe, alusta ilma selleta.',
    playerNamesHeader: 'Mängijad ja kestvus',
    playerNamesHint: 'Vali mitu inimest mängib, kui pikk seiklus tuleb ja milliseid nimesid mäng võiks kasutada.',
    playerNamesNote: 'Nimed on soovituslikud. Kui jätad tühjaks, loob mäng tegelaste nimed ise.',
    ...
    ideaSectionHeader: 'Üks detail, mitte brief',
    ideaSectionHint: 'Lisa ainult üks asi, mida oleks lahe loos näha. See võib olla tänane nali, ese laual või väike ebamugav olukord.',
    ...
    insideJokeLabel: 'Detail, mille võib loosse põimida',
  ...
  en: {
    ...
    durationQuestion: 'Game duration',
    ...
    prevStepBtn: '← Back',
    step1Title: 'Choose the genre',
    step2Title: 'Who is playing?',
    step3Title: 'Anchor the game here',
    step4Title: 'Give the story a spark',
    setupStepLabel: (step, total) => `${step} / ${total}`,
    setupContextNote: 'This field is optional. If nothing good comes to mind, start without it.',
    playerNamesHeader: 'Players and length',
    playerNamesHint: 'Choose how many people are playing, how long the adventure should run, and which names the game can use.',
    playerNamesNote: 'Names are optional. Leave empty and the game will create character names itself.',
    ...
    ideaSectionHint: 'Add one thing that would be fun to see in the story: an in-joke, an object on the table, or a small awkward situation.',
    ...
    insideJokeLabel: 'A detail the story could use',
